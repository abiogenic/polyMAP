...
for organelle in organelles:		# THIS RUNS ONCE FOR EACH ORGANELLAR GENOME
	...
	os.chdir(scripts_dir)
	import haplotype_phasing
	print("\t>> haplotype_phasing.py for " + organelle)
	output_dir_current = str(output_dir + "/" + organelle + "/" + current_date)
	haplotype_phasing.main(output_dir_current,repeat,organelle)

	#change haplotype_parser to haplotype_phasing when completed